...
class TestPersistOrLoadKeyProvenance:
    ...
    def test_generated_key_file_is_mode_0600(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(config_mod, "_KEYS_DIR", str(tmp_path))
        config_mod._persist_or_load_key("k.key", lambda: "generated-value")
    ...
    def test_previous_release_keyfile_without_marker_is_autogenerated(self, tmp_path, monkeypatch):
    ...
    def test_partial_write_cannot_downgrade_provenance(self, tmp_path, monkeypatch):
        ...
        key1, auto1 = config_mod._persist_or_load_key("k.key", lambda: "gen-1")
        assert auto1 is True
        ...
        _key2, auto2 = config_mod._persist_or_load_key("k.key", lambda: "unused")
        assert auto2 is True
